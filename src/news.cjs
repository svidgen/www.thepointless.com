const news = [
	{
		...
		body: `It isn't easy when a dot-com as reputable and beloved as the one and only pointless dot-com falls short of its dedicated patrons' expecations. *And indeed*, we have fallen short. As you can plainly see, our last public update was a whopping **eight months ago** when we promised semi-fungible red dot tokens. "And where are they?" you ask.
		...
		So, that's what we're up against here. Sure, there are still some dots around. But, not as many &mdash; what with all the dots in the sunset now with their beards. But, rest assured, we haven't forgotten about our promise. If push comes to shove, we'll see about coaxing them back with some sweet new rides or something. Or perhaps beard trimmers.
		...
		`.replace(/\t+/g, ''),
		pubDate: new Date("2024-02-25").toGMTString(),
		guid: 'e860b3e4-8789-4e3d-b2c2-ccf09a9c172b',
	},
	{
		...
		body: `It has been suggested that thepointless.com launch
			...
			We do not necessarily disagree. That is why we are beginning to look very
			seriously at the possibility of a <b>semi-fungible red dot token</b>.
			We promise it will be awsome and highly valuable. Please watch our RSS feed for more information in the coming months.`.replace(/\t+/, ''),
		pubDate: new Date("2023-07-10").toGMTString(),
		guid: '890c82c3-7db4-4da9-a4ee-3a8f3508a581',
	}
];
