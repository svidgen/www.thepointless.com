			...
			<div>
				...
				<div class='not-job_container'>
					<div id='Button_Pusher' class='job'>
						...
						<div class='job_description'>Buttons don't push themselves. And there are many buttons to be pushed. Therefore, thepointless.com is seeking several experienced Button Pushers to depress a wide variety of buttons.</div>
						...
						<div class='job_footer'><a href='#top'>Back to top.</a></div>
					</div>

					<div id='Word_Maker' class='job'>
						<h3 class='job_title'>Word Maker</h3>
						<div class='job_description'>We are seeking a skilled maker of words to produce, modify, and utilize words for use in relation to thepointless.com activities.</div>
						<div class='job_section'>
							<h4>Responsibilities</h4>
							<ul>
